                        ...
                        <div class="widget-block widget-block-text">
                            ...
                            <div class="widget-block-container">
                                ...
                                <div class="widget-block-title">
                                    <h6>Получаемая информация</h6>
                                </div><!-- /End Widget Block Title -->
                                <!-- Widget Block Body -->
                                <div class="widget-block-body">
                                    <p>Наш сайт осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация используется с целью предотвращения, выявления и решения технических проблем.</p>
                                    <p></p>
                            ...
                            <div class="widget-block-container">
                                ...
                                <div class="widget-block-body">
                                    ...
                                    <ul class="links-block">
                                        ...
                                        <li><a href="/theme/#" title="Portfolio">О нас</a></li>
                                        <li><a href="/theme/#" title="About us">Контакты</a></li>
                                        <li><a href="/theme/#" title="Privacy Policy">Политика конфиденциальности</a></li>
                                        <li><a href="/theme/#" title="Privacy Policy">Инфармационное партнерство</a></li>
                        ...
                        <div class="copyright-widget-container">
                            ...
                            <div class="info-block">
                                ...
                                <div class="info-block-container">
                                    <p>&copy; 2019 <a href="/theme/http://themeforest.net/user/graphicfort/portfolio?ref=GraphicFort" title="Graphicfort" target="_blank">KMJBlog</a>, все права защищены.</p>
