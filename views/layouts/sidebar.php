        ...
        <div class="widget-block widget-block-text">
            ...
            <div class="widget-block-container">
                ...
                <div class="widget-block-body">
                    ...
                    <p><a href="/theme/mailto:support@example.com" title="Support">info@kazakovmj.ru</a></p>
                    <strong>Телефон:</strong>
                    <p><a href="/theme/tel:+79299713718" title="+7 (929) 971-37-18">+7 (929) 971-37-18</a></p>
                    <p><a href="/theme/tel:+79266789131" title="+7 (926) 678-91-31">+7 (926) 678-91-31</a></p>
                    <strong>Адрес:</strong>
                    <p>г. Москва, м. Марксистская/Таганская, ул. Марксистская, дом 22, ст. 1, подъезд Мосэнергосбыт (дальний от метро), 8 этаж, офис 801/10</p>
                </div><!-- /End Widget Block Body -->
            </div><!-- /End Widget Block Container -->
            ...
            <div class="widget-block-container">
                ...
                <div class="widget-block-body">
                    ...
                    <ul class="categories-block">
                        <li><a href="/theme/#" title="Life Style">Математика<span>(6)</span></a></li>
                        <li><a href="/theme/#" title="Business">Информатика<span>(5)</span></a></li>
                            ...
                            <form method="post" action="#">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-gfort">Связаться</button>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p>Любая иная персональная информация переданная нам, мы никогда не передадим вашу персональные данные кому-либо еще.</p>
                ...
                <div class="widget-block-body">
                    ...
                    <div class="ads-block">
                        ...
                        <div class="ads-block-container">
                            <a href="/theme/http://gfort.co/plume" title="KMJ Blog" target="_blank">
